...
def predict():
    ...
    dpf = st.number_input("No. of times using this antibiotic: (1:Penicillins, 2: Tetracyclines, 3: Cephalosporins, 4: Quinolones, 5: Lincomycins, 6: Macrolides, 7: Sulfonamides, 8: Glycopeptides)")
